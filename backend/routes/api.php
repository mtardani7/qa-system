...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['auth:sanctum', 'throttle:api', 'activity'])->group(function (): void {
        ...
        Route::get('machines/import-template', [MachineController::class, 'template']);
        ...
        Route::get('daily-reports/import-template', [DailyReportImportController::class, 'template']);
        ...
        Route::post('daily-reports/bulk-lock', [DailyReportController::class, 'bulkLock']);
