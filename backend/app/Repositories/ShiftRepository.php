...
final class ShiftRepository extends MasterRepository implements ShiftRepositoryInterface
{
    protected array $searchableColumns = ['code', 'name'];
    public function __construct(Shift $model) { parent::__construct($model); }
