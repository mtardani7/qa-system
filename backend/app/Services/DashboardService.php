...
final class DashboardService
{
    ...
    public function overview(DashboardFilters $filters): array
    {
        ...
        return [
            ...
            'change_over_sections' => $this->dashboard->changeOverBySection($filters),
            'change_over_machines' => $this->dashboard->changeOverByMachine($filters),
            'defect_categories' => $this->dashboard->defectCategories($filters),
            'worst_machine_by_defect_rate' => $this->dashboard->worstMachineByDefectRate($filters),
